...
def msgs(message):
    ...
    if text == "تلاو" or text == "تلاوات" or text == "تلاوة":
        ...
        bot.send_voice(message.chat.id, voice_url, caption="« صلي على سيدنا محمد ﷺ »", reply_to_message_id=message.message_id, reply_markup=telebot.types.InlineKeyboardMarkup().row(
            telebot.types.InlineKeyboardButton(text='✧ - المطور 🌐', url='https://t.me/S_Ml11'),
            telebot.types.InlineKeyboardButton(text='✧ - قناة التحديثات', url='https://t.me/S_Ml19')))

print("تم تشغيل البوت لو وقف شي كلمني @S_Ml11!")
bot.polling()
...
#مطور الملف @@S_Ml11
#جميع الحقوق محفوظه لسورس ليثون